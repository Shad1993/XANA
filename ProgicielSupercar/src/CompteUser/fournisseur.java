...
public class fournisseur extends JFrame {
	...
	public static void main(String login) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					fournisseur frame = new fournisseur(login);
	 ...
	 * @param login 
	 */
	public fournisseur(String login) {
		initialize(login);
		Connect();
		table_load();
	...
	private final Action action = new SwingAction();
	 ...
	 public void Connect()
		...
		public void table_load()
	    {
	    	try 
	    	{
		    pst = con.prepareStatement("SELECT f.IdFournisseur AS ID ,f.NomFournisseur AS Nom,f.NomContacte AS Nomdecontacte,f.Adresse As Adresse,f.Email As Email ,vo.Prix AS Prix,vo.Modele AS Modele FROM fournisseur f,voitures vo");
		    rs = pst.executeQuery();
		...
		public void table_loadAnnuel()
	    {
	    	try 
	    	{
		    pst = con.prepareStatement("SELECT f.IdFournisseur AS ID ,f.NomFournisseur AS Nom,f.NomContacte AS Nomdecontacte,f.Adresse As Adresse,f.Email As Email ,vo.Prix AS Prix,vo.Modele AS Modele FROM fournisseur f,voitures vo WHERE vo.DateMiseEnVente >= Date_add(Now(),interval - 12 month)");
		    rs = pst.executeQuery();
		    table.setModel(DbUtils.resultSetToTableModel(rs));
		} 
	    	catch (SQLException e) 
		...
		public void table_loadJ()
	    {
	    	try 
	    	{
		    pst = con.prepareStatement("SELECT f.IdFournisseur AS ID ,f.NomFournisseur AS Nom,f.NomContacte AS Nomdecontacte,f.Adresse As Adresse,f.Email As Email ,vo.Prix AS Prix,vo.Modele AS Modele FROM fournisseur f,voitures vo WHERE vo.DateMiseEnVente= CURRENT_DATE");
		    rs = pst.executeQuery();
		    table.setModel(DbUtils.resultSetToTableModel(rs));
		} 
	    	catch (SQLException e) 
		...
		public void table_loadM()
	    {
	    	try 
	    	{
		    pst = con.prepareStatement("SELECT f.IdFournisseur AS ID ,f.NomFournisseur AS Nom,f.NomContacte AS Nomdecontacte,f.Adresse As Adresse,f.Email As Email ,vo.Prix AS Prix,vo.Modele AS Modele FROM fournisseur f,voitures vo WHERE MONTH(vo.DateMiseEnVente) = MONTH(CURRENT_DATE()) AND YEAR(vo.DateMiseEnVente) = YEAR(CURRENT_DATE())");
		    rs = pst.executeQuery();
		    table.setModel(DbUtils.resultSetToTableModel(rs));
		} 
	    	catch (SQLException e) 
		...
		public void table_loadH()
	    {
	    	try 
	    	{
		    pst = con.prepareStatement("SELECT f.IdFournisseur AS ID ,f.NomFournisseur AS Nom,f.NomContacte AS Nomdecontacte,f.Adresse As Adresse,f.Email As Email ,vo.Prix AS Prix,vo.Modele AS Modele FROM fournisseur f,voitures vo WHERE  vo.DateMiseEnVente >= DATE_SUB(NOW(), INTERVAL 1 WEEK) GROUP BY WEEK(vo.DateMiseEnVente)");
		    rs = pst.executeQuery();
		    table.setModel(DbUtils.resultSetToTableModel(rs));
		} 
	    	catch (SQLException e) 
	...
	private void initialize(String login) {
		...
		JLabel lblGestionDesCommandes = new JLabel("Bilan des paiements fournisseur");
